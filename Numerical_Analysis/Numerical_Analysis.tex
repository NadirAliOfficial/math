...
\begin{tcolorbox}[
  ...
  {\large\color{lightbg}
    A Deep Research Study of Root-Finding Methods
  }
\end{tcolorbox}
...
\begin{tcolorbox}[colback=purplebg!60, colframe=purpleclr, arc=4pt, boxrule=1pt,
  ...
  borderline west={4pt}{0pt}{purpleclr}]
\textbf{\color{purpleclr}Scope of this Document:} This document provides a rigorous, research-level treatment of the five fundamental numerical root-finding methods. Each method is examined from multiple perspectives: its historical origins, complete mathematical derivation, formal convergence proofs, error analysis, important variants and improvements, connections to other areas of mathematics, and practical implementation guidelines. The treatment is intended for advanced undergraduate students of mathematics (BS-IV level).
\end{tcolorbox}
